...
function Buttons() {
    return (
        <div className="flex flex-col items-center justify-between gap-[1rem] xl:flex-row">
            ...
            <button className="flex h-[2.975rem] w-[10.75rem] items-center justify-center gap-[0.625rem] rounded-[0.5rem] border-[0.05rem] border-primary bg-[#FEF4F2] text-white transition-colors duration-300 ease-in-out hover:bg-primary/20">
                <Image src={DeleteIcon} alt="delete" />
                <p className="text-nowrap text-[1rem] font-medium text-primary">
                    Delete job
                </p>
            </button>
            <button className="flex h-[3.125rem] w-[10.75rem] items-center justify-center gap-[0.625rem] rounded-[0.5rem] border-[0.125rem] border-[#FED3CA] bg-primary transition-colors duration-300 ease-in-out hover:bg-primary/75">
